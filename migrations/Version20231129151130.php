 ...
 */
final class Version20231129151130 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE articles ALTER status TYPE INT USING status::integer');
        $this->addSql('ALTER TABLE articles ALTER status SET DEFAULT 0');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE articles ALTER status TYPE BOOLEAN');
        $this->addSql('ALTER TABLE articles ALTER status DROP DEFAULT');
        $this->addSql('COMMENT ON COLUMN articles.status IS NULL');
