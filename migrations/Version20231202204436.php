 ...
 */
final class Version20231202204436 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE items_properties_preset RENAME COLUMN "default" TO is_default');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE items_properties_preset RENAME COLUMN is_default TO "default"');
