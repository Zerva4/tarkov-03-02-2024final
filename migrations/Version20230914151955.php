 ...
 */
final class Version20230914151955 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('COMMENT ON COLUMN items_properties_weapon.recoil_vertical IS \'Макс. прочность\'');
        $this->addSql('COMMENT ON COLUMN items_properties_weapon.recoil_horizontal IS \'Вертикальная отдача\'');
        $this->addSql('COMMENT ON COLUMN items_properties_weapon.default_width IS \'Высота по умолчанию\'');
