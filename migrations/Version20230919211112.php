 ...
 */
final class Version20230919211112 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE items_calibers ADD is_ammo BOOLEAN DEFAULT false NOT NULL');
        $this->addSql('ALTER TABLE items_calibers ALTER published SET DEFAULT false');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE items_calibers DROP is_ammo');
        $this->addSql('ALTER TABLE items_calibers ALTER published DROP DEFAULT');
