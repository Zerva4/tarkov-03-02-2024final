 ...
 */
final class Version20230901115749 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Update map fields';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE maps_translation ALTER description DROP NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE maps_translation ALTER description SET NOT NULL');
