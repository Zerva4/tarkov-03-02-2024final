 ...
 */
final class Version20230919085447 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE traders_cash_offers ALTER currency DROP NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE traders_cash_offers ALTER currency SET NOT NULL');
