 ...
 */
final class Version20230901001613 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE items_properties (id UUID NOT NULL, item_id UUID DEFAULT NULL, material_id UUID DEFAULT NULL, grids_id UUID DEFAULT NULL, type_property VARCHAR(50) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('COMMENT ON COLUMN items_properties_ammo.caliber IS \'Калибр\'');
        ...
        $this->addSql('CREATE TABLE items_properties_scope (id UUID NOT NULL, ergonomics DOUBLE PRECISION DEFAULT \'0\' NOT NULL, sight_modes JSONB DEFAULT NULL, sighting_range DOUBLE PRECISION DEFAULT \'0\' NOT NULL, recoil_modifier DOUBLE PRECISION DEFAULT \'0\' NOT NULL, zoom_levels JSONB DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('COMMENT ON COLUMN items_properties_weapon.caliber IS \'Калибр\'');
        ...
        $this->addSql('CREATE TABLE items_translation (id UUID NOT NULL, translatable_id UUID DEFAULT NULL, name VARCHAR(255) DEFAULT NULL, short_name VARCHAR(255) NOT NULL, description TEXT DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, locale VARCHAR(5) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE maps_translation (id UUID NOT NULL, translatable_id UUID DEFAULT NULL, name VARCHAR(255) NOT NULL, description TEXT NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, locale VARCHAR(5) NOT NULL, PRIMARY KEY(id))');
