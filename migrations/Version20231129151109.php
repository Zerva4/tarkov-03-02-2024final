 ...
 */
final class Version20231129151109 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE articles DROP status');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE articles ADD status BOOLEAN NOT NULL');
