 ...
 */
final class Version20231026005540 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE traders_standings ADD standing DOUBLE PRECISION DEFAULT \'0\' NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE traders_standings DROP standing');
