 ...
 */
final class Version20230901121322 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Added field blocksHeadphones';
    }

    public function up(Schema $schema): void
    {
        // this up() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE items ADD blocks_headphones BOOLEAN DEFAULT false NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE items DROP blocks_headphones');
